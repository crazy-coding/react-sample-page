      ...
      <Modal isOpen={this.state.isOpen} toggle={this.togglePopup} size="lg" className="wallet-popup">
        <ModalHeader toggle={this.togglePopup} close={
          <button className="close" onClick={this.togglePopup}>
            ...
            <path d="M30 10L10 30" stroke="#798A9E" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M10 10L30 30" stroke="#798A9E" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </button>
